...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var hour = (0, _moment.default)(start).format('HH:mm A');
    var showAsAllDay = isAllDay || allDay || dates.diff(start, dates.ceil(end, 'day'), 'day') > 1;
    var userProps = getters.eventProp(event, start, end, selected);
    var diffMins = (0, _moment.default)().diff((0, _moment.default)(start).add(1, 'minutes'), 'minutes');
    var is15MinAfterBefore = -15 <= diffMins && diffMins <= 15;
    var isPastSession = end < (0, _moment.default)();
    var backgroundColor = is15MinAfterBefore ? 'rgb(38, 38, 38)' : isPastSession ? '#EBEBEB' : '#909090';

    var content = _react.default.createElement("div", {
      className: "rbc-event-content",
      style: {
        color: is15MinAfterBefore ? 'white' : end < (0, _moment.default)() ? '#909090' : 'white'
      },
    ...
    return _react.default.createElement(EventWrapper, (0, _extends3.default)({}, this.props, {
      type: "date"
    }), _react.default.createElement("div", (0, _extends3.default)({}, props, (_extends2 = {
      tabIndex: 0,
      style: (0, _extends3.default)({}, userProps.style, style),
      ...
      color: 'black'
    }, _extends2.onClick = function onClick(e) {
      return onSelect && onSelect(event, e);
    }, _extends2.onDoubleClick = function onDoubleClick(e) {
      return _onDoubleClick && _onDoubleClick(event, e);
    }, _extends2.onKeyPress = function onKeyPress(e) {
      return _onKeyPress && _onKeyPress(event, e);
    }, _extends2)), typeof children === 'function' ? children(content) : content));
  };
