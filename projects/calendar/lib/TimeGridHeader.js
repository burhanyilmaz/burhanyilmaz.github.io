...
function (_React$Component) {
  ...
  _proto.renderHeaderCells = function renderHeaderCells(range) {
    ...
    return range.map(function (date, i) {
      ...
      var splittedData = label.split(' ');
      var dayName = splittedData[0];
      var dayNumber = splittedData[1].split('/')[0];
      var isActiveDate = (0, _moment.default)().format('DD MM YY').toString() === (0, _moment.default)(date).format('DD MM YY').toString();
      var activeDayNumberStyle = isActiveDate ? {
        height: 30,
        width: 30,
      ...
      }, dayName), _react.default.createElement("div", {
        style: activeDayNumberStyle
      }, dayNumber));
