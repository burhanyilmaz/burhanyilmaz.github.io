...
function (_Component) {
  ...
  function TimeGutter() {
    ...
    _this.renderSlot = function (value, idx, isBordered) {
      ...
      return _react.default.createElement("div", {
        ...
        className: ""
      }, localizer.format(value, 'timeGutterFormat'))), _react.default.createElement("div", {
        style: {
          marginTop: 0,
          display: 'flex',
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement("div", {
      ...
      return _react.default.createElement(_TimeSlotGroup.default, {
        ...
        getters: getters,
        lastColumnDate: _this2.props.lastColumnDate
      });
    }));
  };
...
TimeGutter.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  lastColumnDate: _propTypes.default.string,
