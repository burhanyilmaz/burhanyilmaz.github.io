...
function (_Component) {
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        lastColumnDate = _this$props.lastColumnDate,
    ...
    return _react.default.createElement("div", (0, _extends2.default)({
      ...
      var isBordered = (0, _moment.default)(value).format('DD MM YY').toString() === (0, _moment.default)(lastColumnDate).format('DD MM YY').toString();
      ...
      return _react.default.createElement(Wrapper, {
        ...
        className: (0, _clsx.default)('rbc-time-slot', slotProps.className, isBordered ? 'rbc-time-slot-last-column' : {}),
        style: {
          borderWidth: 1
        }
